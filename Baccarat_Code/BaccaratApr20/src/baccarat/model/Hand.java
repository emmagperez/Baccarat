...
public class Hand {
	...
	public void newHand()
	{
		for (int i = 0; i < 2; i++) // Card-construction loop
		{
	...
	public void dealPlayerCard() {
		randomValue = ThreadLocalRandom.current().nextInt(1, 53);
		cards[2] = new BaccaratCard(randomValue);
	}
	...
	public int getThirdCard() {
		int thirdCard = cards[2].getValue();
		return thirdCard;
	}

	public ImageView getImage(int cardNum)
	{
		return cards[cardNum].cardFrontImage;
	}
